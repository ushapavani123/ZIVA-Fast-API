...
from ReadTextfiles import rank_exercise_files, print_top_three_justification, load_criteria
...
exercise_folder_path = "/Users/purvamugdiya/PycharmProjects/Exercise/pythonProject1/Ranking_Selection"
# Load criteria (assuming the criteria.json file is in the same folder as ExerciseMain.py)
criteria_file = "/Users/purvamugdiya/PycharmProjects/Exercise/pythonProject1/criteria.json"
...
def finding_template(request: Request):
    ...
    """
    #unique_exercises_count = count_unique_exercises(df)
    return templates.TemplateResponse("Scraperrecommendations.html", {"request": request})


# Define the function to retrieve file names
def get_file_names():
    """
        Retrieve file names of exercise files.
    """
...
def get_priority_files(request: Request):
    ...
    return templates.TemplateResponse("priority_files.html",
...
def get_selected_files(request: Request):
    ...
    return templates.TemplateResponse("Selected_Files.html", {"request": request, "top_three_files": top_three_files,
...
def root(request: Request):
    """
        ...
        """
    file_names = get_file_names()
    return templates.TemplateResponse("index.html", {"request": request, "file_names": file_names})


@app.get("/exercise")
def get_exercises():
    """
        Display different visualizations of exercises.
        """
    exercise_content = """
    <div>
        <h4>Push-Up</h4>
        <img class="exercise-image" src="https://www.example.com/push-up.jpg" alt="Push-Up">
        <p>Description of push-up exercise...</p>
    </div>
    <div>
        <h4>Squats</h4>
        <img class="exercise-image" src="https://www.example.com/squats.jpg" alt="Squats">
        <p>Description of squats exercise...</p>
    </div>
    """
...
async def get_hourly_calorie_blasters():
    return FileResponse("templates/scraperindex.html")
